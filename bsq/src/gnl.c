...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/09/12 23:38:24 by pcollio-          #+#    #+#             */
/*   Updated: 2018/09/12 23:38:26 by pcollio-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../include/headers.h"

ssize_t	find_n(const char *mas)
{
	ssize_t		i;
...
int		write_arr(char **arr, ssize_t *ret, const int fd, char *fr_arr)
{
	char		*buf;
...
int		get_first_line(char **arr, char **line, ssize_t ret)
{
	ssize_t			i;
	char			*free_old_arr;
...
int		make_new_fd(const int fd, t_gnl **poi, t_gnl *l)
{
